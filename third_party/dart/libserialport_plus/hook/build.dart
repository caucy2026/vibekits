...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    final cbuilder = CBuilder.library(
      ...
      flags: [
        // Flutter currently hard-codes macOS native assets to 13 even when
        // the Runner target is 12 (flutter/flutter#145104). This later flag
        // deliberately overrides that default for Vibekits' macOS 12 floor.
        if (targetOS == OS.macOS) '-mmacos-version-min=12.0',
        if (isPosix) ...[
          '-std=c99',
          '-Wall',
          '-Wextra',
