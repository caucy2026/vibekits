...
''');
        ...
        final library = CBuilder.library(
          ...
          defines: defines,
          flags: [
            // Flutter currently hard-codes macOS native assets to 13 even
            // when the Runner target is 12 (flutter/flutter#145104). The
            // later flag preserves Vibekits' documented macOS 12 floor.
            if (input.config.code.targetOS == OS.macOS)
              '-mmacos-version-min=12.0',
            if (input.config.code.targetOS == OS.linux) ...[
