...
- 2026-09-24 本轮 Harness/商城 71 项测试通过（1 项按条件跳过），新增相对路径契约与 Termux 不可代替正式组件的回归通过；Dart 静态分析和 Android 宿主/组件 Release 编译通过。最终组件候选 `1.0.1`（versionCode 2）Release APK 为 91,235,035 字节，SHA-256 `bde417ae294aec26ef4bcf9851893b4e2fcc02b2b724699c8c4533d4b0b9bfb0`，证书 SHA-256 仍为 `c8a2e9bccf597c2fb6dc66bee293fc13f2fc47ec77bc6b2b0d52c11f51192ab8`，内嵌工具链 ZIP 哈希与固定值一致；包内增加了 `licenses/` 第三方许可声明。宿主候选 `1.9.0-dev.254+2254` 为 86,846,549 字节，SHA-256 `c322d1a8cfc6cd6709aec08051f8d7a9f13a9becfbd7d1ec00371bc12ca22285`，同一证书。两个包尚未在 PAD63 以最终字节实装验证，不能据此解除真机与商城门禁。
